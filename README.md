...
```javascript
sdssumpw = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-sdssumpw@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-sdssumpw/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/blas-ext-base-sdssumpw/actions/workflows/test.yml?query=branch:v0.2.2
